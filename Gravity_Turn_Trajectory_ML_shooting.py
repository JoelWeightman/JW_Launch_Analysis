...
def set_variables(m_dry, stage_mass_ratios):
    ...
    return g, G_c, M_e, R_e, t_steps, Isp_design, thrust_design, rocket_radius, Cd, target_altitude, delta_vee_req, stage_m_dry, orbital_vel, R_air, R_prop, gamma, P_chamber, T_chamber

def calculate_trajectory(delta_vee_req, stage_delta_vee_ratios, Isp_design, stage_m_dry, t_steps, g, G_c, M_e, R_e, thrust_design, rocket_radius, Cd, event_alt, GT_angle, R_air, R_prop, gamma, P_chamber, T_chamber, alpha, accel_init, coast_on = False):
...
#        mass_ratio = np.exp(delta_vee_stage/(Isp_design*g))
        ...
        trajectory1 = odeint(model_burn, init_conds, t1, args=(G_c,M_e,R_e,stage_m_dot[0],thrust_design,rocket_radius,Cd,R_air,R_prop,gamma,P_chamber,T_chamber,0))
        ...
        trajectory2 = odeint(model_burn, event_conds, t2, args=(G_c,M_e,R_e,stage_m_dot[0],thrust_design,rocket_radius,Cd,R_air, R_prop,gamma,P_chamber,T_chamber,alpha))
...
#        delta_vee_1 = delta_vee_step[-1]
        ...
        trajectory3 = odeint(model_burn, second_stage_conds, t3, args=(G_c,M_e,R_e,stage_m_dot[1],thrust_design,rocket_radius,Cd,R_air, R_prop,gamma,P_chamber,T_chamber,alpha))
...
#        print(t4)
        ...
        trajectory4 = odeint(model_burn, coast_conds, t4, args=(G_c,M_e,R_e,0,0,rocket_radius,Cd,R_air, R_prop,gamma,P_chamber,T_chamber,0))
